...
import { useToggleAlwaysOnTop } from "@/hooks/use-toggle-always-on-top";
import { OverlayImage } from "@/components/complex/overlay-image";
...
export const Overlay = () => {
	...
	const { isAlwaysOnTop } = useToggleAlwaysOnTop();
		...
		<div className="relative">
			<div style={{ opacity }}>
				<div className="bg-white min-h-screen min-w-screen">
					<OverlayImage src={fileSrc} isInvert={isInvert} />
					{/* <img
